...
Item {
  ...
  component BarPanel: PanelWindow {
    ...
    margins {
      top: root.barHidden && root.position === "top" ? -root.barSize : (root.position === "top" ? 6 : 0)
      bottom: root.barHidden && root.position === "bottom" ? -root.barSize : (root.position === "bottom" ? 6 : 0)
      left: root.barHidden && root.position === "left" ? -root.barSize : 10
      right: root.barHidden && root.position === "right" ? -root.barSize : 10
    }
    ...
    Component {
      ...
      Item {
        ...
        Rectangle {
          ...
          implicitWidth: leftModules.width + Style.space(16)
        ...
        // 2. Center Island (Pill)
        Rectangle {
          id: centerPill
          anchors.centerIn: parent
          implicitHeight: root.barSize
          implicitWidth: centerModules.width + Style.space(16)
          height: implicitHeight
          width: implicitWidth
          color: root.transparent ? "transparent" : root.background
          radius: 12
        ...
        Rectangle {
          ...
          anchors.verticalCenter: parent.verticalCenter
          implicitHeight: root.barSize
          implicitWidth: rightModules.width + Style.space(16)
          height: implicitHeight
          width: implicitWidth
          color: root.transparent ? "transparent" : root.background
          radius: 12
    ...
    Component {
      ...
      Item {
        ...
        Rectangle {
          ...
          implicitHeight: leftModulesV.height + Style.space(16)
          height: implicitHeight
          width: implicitWidth
          color: root.transparent ? "transparent" : root.background
          radius: 12
          border.color: Qt.rgba(1, 1, 1, 0.09)
          border.width: 1
          visible: leftModulesV.entries.length > 0
        ...
        Rectangle {
          ...
          anchors.centerIn: parent
          implicitWidth: root.barSize
          implicitHeight: centerModulesV.height + Style.space(16)
          height: implicitHeight
          width: implicitWidth
          color: root.transparent ? "transparent" : root.background
          radius: 12
          border.color: Qt.rgba(1, 1, 1, 0.09)
          border.width: 1
          visible: centerModulesV.entries.length > 0
        ...
        Rectangle {
          ...
          anchors.horizontalCenter: parent.horizontalCenter
          implicitWidth: root.barSize
          implicitHeight: rightModulesV.height + Style.space(16)
          height: implicitHeight
          width: implicitWidth
          color: root.transparent ? "transparent" : root.background
          radius: 12
          border.color: Qt.rgba(1, 1, 1, 0.09)
          border.width: 1
          visible: rightModulesV.entries.length > 0
