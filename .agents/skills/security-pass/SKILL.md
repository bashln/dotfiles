---
name: security-pass
description: Runs a defensive, local-first security pass on the operator's own Python or Node codebase with websec-validator. Use when the user requests a security review, audit, hardening check, BOLA/IDOR/JWT/SSRF/mass-assignment assessment, authorized self-pentest, or asks whether their app is safe before shipping.
---
